...
export const AppleIcon = ({ checked }) => {
  return (
    <div className={`${checked ? "bg-secondary" : ""} p-4 w-24 h-24 rounded m-2`}>
      <svg width="100%" height="100%" viewBox="0 0 32 32" className="fill-primary dark:fill-dark-primary">
...
export const WindowsIcon = ({ checked }) => {
  return (
    <div className={`${checked ? "bg-secondary" : ""} p-4 w-24 h-24 rounded m-2`}>
      <svg width="100%" height="100%" viewBox="0 0 32 32" className="fill-primary dark:fill-dark-primary">
        <path
